...
def main():
    ...
    if args.profile == 'high_concurrency':
        config_dict = ProductionLoadConfig.get_dsl_high_concurrency_config(args.ramp_step, args.duration)
        ProductionLoadConfig.apply_dsl_config_to_queries(queries, config_dict)
    elif args.profile == 'concurrent':
        config_dict = ProductionLoadConfig.get_dsl_concurrent_config(args.ramp_step)
        ProductionLoadConfig.apply_dsl_config_to_queries(queries, config_dict)
    elif args.profile == 'single_query_exponential':
